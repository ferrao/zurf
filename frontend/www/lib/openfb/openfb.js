...
angular.module('openfb', []).factory('OpenFB', function($rootScope, $q, $window, $http) {
    ...
    var FB_LOGIN_URL = 'https://www.facebook.com/dialog/oauth',
        ...
        oauthRedirectURL = baseURL + '/lib/openfb' + '/oauthcallback.html',

        logoutRedirectURL = baseURL + '/lib/openfb' + '/logoutcallback.html',
